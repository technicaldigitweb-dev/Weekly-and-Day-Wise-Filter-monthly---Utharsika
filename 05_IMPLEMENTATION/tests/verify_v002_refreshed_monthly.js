...
var pair = Engine.computeRowsV4(canonicalRows,
  Engine.sumRangeSplitByAsinSkuV4(splitIndex, "2026-06-01", "2026-06-30"), {},
  Engine.sumVendorRangeV4(vendorPeriods, "2026-06-01", "2026-06-30"), {})
  .filter(function (r) { return r.asin === "B0FX2QT3B1"; });
console.log("\n=== B0FX2QT3B1 June 2026 rows ===");
console.log(JSON.stringify(pair, null, 2));
var totalSales = pair.reduce(function (a, r) { return a + r.totalSales; }, 0);
var totalOrders = pair.reduce(function (a, r) { return a + r.totalOrders; }, 0);
var totalQty = pair.reduce(function (a, r) { return a + r.totalQuantity; }, 0);
console.log("ASIN totals: Sales=" + totalSales.toFixed(2) + " Orders=" + totalOrders + " Quantity=" + totalQty);
