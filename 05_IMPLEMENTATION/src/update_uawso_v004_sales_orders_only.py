"""
Authorized UPDATE of the specific, already-published
09_OUTPUTS\\2026-07-15_utharsika_v004.html only (Sales-and-Orders-only /
Vendor-Orders-included correction, REQ-02-D01 Section 3.2 same-day
amendment). Refuses to run unless the target filename is exactly
"2026-07-15_utharsika_v004.html", the current on-disk hash matches the
expected pre-update hash, and a matching backup exists.
"""
...
STAGING_PATH = os.path.join(ROOT, "09_OUTPUTS", "staging", "2026-07-15_utharsika_v004_sales_orders_only.staging.html")
BACKUP_PATH = os.path.join(ROOT, "09_OUTPUTS", "staging", "2026-07-15_utharsika_v004_before_sales_orders_only_vendor_orders_update.html")
...
EXPECTED_PRE_UPDATE_HASH = "51865bbb45a5b49c15c74156723efa12d8ec6211f397487e9dec12f288587b24"
...
def main():
    ...
    os.replace(TEMP_PATH, TARGET_PATH)  # authorized overwrite of this ONE specific, explicitly-approved file
