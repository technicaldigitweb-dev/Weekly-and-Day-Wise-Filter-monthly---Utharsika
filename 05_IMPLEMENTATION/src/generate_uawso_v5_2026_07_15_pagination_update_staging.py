"""
Regeneration script for the sticky-pagination-bar UI update to the
unpublished v004 report (REQ-02-D01 follow-up).
...
render_dashboard_v5() (only the template changed).

Writes:
    09_OUTPUTS\\staging\\2026-07-15_utharsika_v004_pagination_update.staging.html
...
def main():
    ...
    html = dashboard_renderer.render_dashboard_v5(
        ...
        version=VERSION, template_version="5.2.0-sticky-pagination",
    ...
    staging_path = os.path.join(STAGING_DIR, f"{RUN_DATE}_utharsika_{VERSION}_pagination_update.staging.html")
