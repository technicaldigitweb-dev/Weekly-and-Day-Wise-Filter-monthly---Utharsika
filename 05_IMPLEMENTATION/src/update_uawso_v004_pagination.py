...
09_OUTPUTS\\2026-07-15_utharsika_v004.html only (sticky pagination bar,
page info, Previous/Next, go-to-page).

Mirrors the safety pattern of update_uawso_v004_sticky_and_export.py:
refuses to run unless the target filename is exactly
"2026-07-15_utharsika_v004.html", the current on-disk hash matches the
expected pre-update hash, a matching backup exists, and (read-only,
checked separately in this task) no ph_task row references this
identity.
"""
...
STAGING_PATH = os.path.join(ROOT, "09_OUTPUTS", "staging", "2026-07-15_utharsika_v004_pagination_update.staging.html")
BACKUP_PATH = os.path.join(ROOT, "09_OUTPUTS", "staging", "2026-07-15_utharsika_v004_before_pagination_update.html")
...
EXPECTED_PRE_UPDATE_HASH = "8a52c1585c958c2cb5b229e7d0b0fdd457dad3165fd19a1ee65d2cfbb994d33b"
