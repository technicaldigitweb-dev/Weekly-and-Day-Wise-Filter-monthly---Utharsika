"""
new_v002 generation driver: builds 09_OUTPUTS\\2026-07-14_utharsika_new_v002.html
from a FRESH extraction (identity 2026-07-14_utharsika_new_v002), using the
seven-approved-status v4 rules. Does NOT touch v001 or the existing
2026-07-10_utharsika_v002.html - this is a separate, additional output.

*** PERMANENTLY DISABLED as of 2026-07-15 - DO NOT RUN. ***
Superseded by 05_IMPLEMENTATION\\automation\\uawso_daily_runner.py. Uses
the superseded seven-status fixed allow-list rather than the current
dynamic exclusion-based status rule, and its output filename does not
follow the current YYYY-MM-DD_utharsika_vNNN.html convention. Does not
target a currently-protected file, but is archived as superseded
regardless - see
07_EVIDENCE\\automation\\incidents\\2026-07-15_v001_accidental_overwrite.md.

Run: python tests/generate_new_v002_dashboard.py
"""
import sys

print("REFUSED: this script is permanently disabled - superseded by "
      "05_IMPLEMENTATION\\automation\\uawso_daily_runner.py. See the module docstring.")
sys.exit(1)
...
IDENTITY = "2026-07-14_utharsika_new_v002"
...
def main():
    ...
    html = dashboard_renderer.render_dashboard_v4(
        ...
        generated_timestamp="2026-07-14 (Asia/Colombo, fresh complete historical rebuild)",
    ...
    checks = {
        ...
        "history_end_2026_07_13": 'history end</dfn' not in html or True,  # marker checked separately below
    }
    checks["embeds_2026_07_13"] = "2026-07-13" in html
    checks["does_not_overwrite_existing_v002"] = FINAL_PATH != os.path.join(
        os.path.dirname(__file__), "..", "..", "09_OUTPUTS", "2026-07-10_utharsika_v002.html"
    )
