"""
v002 generation driver: builds 09_OUTPUTS\\2026-07-10_utharsika_v002.html
using the v4 engine (Ordered Product Sales / Total Orders / Total
Quantity rules) and the v4 template. Does NOT touch v001's path,
template, generator, or engine functions - purely additive.

*** PERMANENTLY DISABLED as of 2026-07-15 - DO NOT RUN. ***
09_OUTPUTS\\2026-07-10_utharsika_v002.html is a protected baseline file
...
with non-original bytes - the same failure mode already confirmed for
generate_final_dashboard_v3.py. Archived; kept for historical reference
only.

Run: python tests/generate_v002_dashboard.py
"""
import sys
...
def main():
    ...
    html = dashboard_renderer.render_dashboard_v4(
        ...
        generated_timestamp="2026-07-14 (Asia/Colombo, refreshed through 2026-07-13)",
